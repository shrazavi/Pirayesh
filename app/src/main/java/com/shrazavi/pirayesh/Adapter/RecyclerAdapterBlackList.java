...
import com.shrazavi.pirayesh.Activity.ActivityBlockuser;
...
//        Log.i("LOG","recycler done");
        ...
        Call<User> calluser = RI.getusernumber(content, userInfo, BasicActivity.number);
        calluser.enqueue(new Callback<User>() {
            @Override
            public void onResponse(Call<User> call, Response<User> response) {
                holder.txtUsername.setText(response.body().getName());
                holder.txtnumber.setText(response.body().getNumber());
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    public boolean onMenuItemClick(MenuItem item) {
                        switch (item.getItemId()) {
                            case R.id.unblock:
                                //handle menu1 click
                                Call<Barber> callbarber = RI.getbarber(content, username, BasicActivity.number);
                                callbarber.enqueue(new Callback<Barber>() {
                                    ...
                                    public void onResponse(Call<Barber> call, Response<Barber> response) {
                                        ...
                                        Call<MessageSignup> callvakil = RI.upgradeblack(content,username,
                                                result.toString(),
...
//        });
    ...
    public class ChatViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView txtUsername, txtprofile,txtnumber;
        ...
        public ChatViewHolder(View itemView) {
            ...
            txtnumber = (TextView) itemView.findViewById(R.id.txt_black_number);
