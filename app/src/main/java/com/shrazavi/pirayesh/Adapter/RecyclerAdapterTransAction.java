...
//
    ...
    public class transViewHolder extends RecyclerView.ViewHolder {
        ...
        public transViewHolder(View itemView) {
            ...
            lineartrans = (LinearLayout) itemView.findViewById(R.id.lay_item_transaction);
