...
//                detail = SymmetricAlgorithmAES.encrypt(userid + "/" + random + "/" + edtprice.getText() + "/" + "un"+"/"+BasicActivity.name, BasicActivity.preferences.getString("k5", "not"));
//
//                Call<MessageSignup> calladdtrans = RI.AddTransaction(content, userid,BasicActivity.name, random, edtprice.getText().toString(), "unsuccessful", detail);
